...
import { Store, Plus, Trash2, MapPin, ExternalLink, Image } from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="glass-dark rounded-2xl p-6 lg:p-8 overflow-y-auto max-h-[85vh] custom-scrollbar">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-2xl font-bold tracking-wide">Nova Empresa</h1>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full min-h-[100px] p-3 rounded-xl input-dark text-sm custom-scrollbar" 
                />
              </div>
            </div>
